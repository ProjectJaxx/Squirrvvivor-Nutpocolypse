...
export const GameOver: React.FC<GameOverProps> = ({ score, timeSurvived, kills, onRestart, onMenu }) => {
  ...
  return (
    <div className="absolute inset-0 bg-black/80 flex items-center justify-center z-50 backdrop-blur-sm p-4">
      <div className="bg-gray-900 border-2 border-red-800 p-6 md:p-8 rounded-xl max-w-lg w-full text-center shadow-2xl">
        <h2 className="text-4xl md:text-5xl font-bold text-red-500 pixel-font mb-6">YOU DIED</h2>
        ...
        <div className="bg-gray-800 p-4 md:p-6 rounded-lg mb-6 border border-gray-700">
            <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-gray-700 p-3 rounded">
                    <div className="text-[10px] md:text-xs text-gray-400">TIME ALIVE</div>
                ...
                <div className="col-span-2 bg-gray-700 p-3 rounded flex items-center justify-center gap-3">
                    ...
                    <div className="text-lg md:text-xl text-white font-bold">{kills} KILLS</div>
                </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            <button 
                onClick={onRestart}
                className="flex items-center justify-center gap-2 px-8 py-3 bg-red-600 hover:bg-red-500 rounded-lg font-bold text-white transition shadow-lg shadow-red-900/20"
            >
