...
export const COMPANION_COLORS = {
    HEALER: '#F687B3', // Pink
    WARRIOR: '#E53E3E', // Red (Damage)
    SCOUT: '#FAF089', // Yellow (Speed)
    SNIPER: '#4299E1', // Blue (Attack Speed/Range)
    ARCTIC: '#81E6D9', // Cyan/Teal
    DESERT: '#DD6B20'  // Burnt Orange
};
...
export const STAGE_CONFIGS: Record<StageDuration, { waveDuration: number }> = {
  STANDARD: {
    waveDuration: 180 // 3 minutes
  },
  LONG: {
    waveDuration: 300 // 5 minutes
  },
  EPIC: {
    waveDuration: 600 // 10 minutes
  }
};
...
export const BASE_UPGRADES_LIST: BaseUpgradeDef[] = [
    ...
    // --- COMPANION UNLOCKS (ARMORY) ---
    {
        id: 'UNLOCK_COMP_HEALER',
        name: 'Hire Nurse',
        description: 'Start with a Healer Squirrel (Restores 2% HP/5s).',
        icon: '🩺',
        baseCost: 1500,
        costMultiplier: 1,
        maxLevel: 1,
        statKey: 'unlock_companion',
        increment: 1,
        companionType: 'HEALER'
    },
    {
        id: 'UNLOCK_COMP_WARRIOR',
        name: 'Hire Soldier',
        description: 'Start with a Warrior Squirrel (+25% Damage).',
        icon: '⚔️',
        baseCost: 1500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    {
        id: 'UNLOCK_COMP_SCOUT',
        name: 'Hire Scout',
        description: 'Start with a Scout Squirrel (+50% Speed).',
        icon: '🚩',
        baseCost: 1500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    {
        id: 'UNLOCK_COMP_SNIPER',
        name: 'Hire Sniper',
        description: 'Start with a Sniper Squirrel (+35% Attack Speed).',
        icon: '🎯',
        baseCost: 1500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    {
        id: 'UNLOCK_COMP_ARCTIC',
        name: 'Hire Arctic',
        description: 'Start with an Arctic Squirrel (Slows Enemies).',
        icon: '❄️',
        baseCost: 3500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    {
        id: 'UNLOCK_COMP_DESERT',
        name: 'Hire Desert',
        description: 'Start with a Desert Squirrel (Fire Aura).',
        icon: '🔥',
        baseCost: 3500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    // --- WEAPON UNLOCKS (ARMORY) ---
    {
        id: 'UNLOCK_WEAPON_STORM',
        name: 'Nut Storm',
        description: 'Unlock ability: Rains nuts from the sky.',
        icon: '⛈️',
        baseCost: 2500,
        costMultiplier: 1,
        maxLevel: 1,
        statKey: 'unlock_weapon',
        increment: 1,
        weaponConfig: {
            type: 'NUT_STORM',
            level: 1,
    ...
    {
        id: 'UNLOCK_WEAPON_BARRAGE',
        name: 'Nut Barrage',
        description: 'Unlock ability: Rapid-fire nut stream.',
        icon: '🔫',
        baseCost: 2500,
        costMultiplier: 1,
        maxLevel: 1,
    ...
    {
        id: 'UNLOCK_WEAPON_LEAF',
        name: 'Leaf Swarm',
        description: 'Unlock ability: Knockback tornados.',
        icon: '🍃',
        baseCost: 2500,
        costMultiplier: 1,
        maxLevel: 1,
